...
SUPEE-6788 | CE_1.7.0.2 | v1 | 0398c4b951d9a0f64495e7b8b3b8ca480952dd70 | Fri Oct 23 13:50:23 2015 +0300 | cfc252b
...
diff --git app/code/core/Mage/Admin/sql/admin_setup/upgrade-1.6.1.0-1.6.1.1.php app/code/core/Mage/Admin/sql/admin_setup/upgrade-1.6.1.0-1.6.1.1.php
new file mode 100644
index 0000000..19d4f1f
--- /dev/null
...
+            'changeforgotten',
             ...
             'resetpasswordpost',
             'confirm',
@@ -258,12 +262,17 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
      */
...
@@ -355,7 +364,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -366,9 +375,8 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -586,21 +594,37 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
     /**
...
+
             ...
             $this->_getSession()->addError(Mage::helper('customer')->__('Your password reset link has expired.'));
             $this->_redirect('*/*/forgotpassword');
@@ -615,10 +639,9 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
      */
...
+        $passwordConfirmation = (string)$this->getRequest()->getPost('confirmation');
         ...
         try {
             $this->_validateResetPasswordLinkToken($customerId, $resetPasswordLinkToken);
@@ -647,10 +670,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -660,14 +680,15 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -844,4 +865,34 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
     {
...
index 664137d..40666e6 100644
--- app/design/frontend/default/iphone/layout/customer.xml
+++ app/design/frontend/default/iphone/layout/customer.xml
@@ -155,7 +155,7 @@ New customer registration
         </reference>
     </customer_account_forgotpassword>
...
+    <customer_account_changeforgotten translate="label">
         ...
         <remove name="right"/>
         <remove name="left"/>
@@ -174,9 +174,9 @@ New customer registration
             </action>
         </reference>
         <reference name="content">
-            <block type="customer/account_resetpassword" name="resetPassword" template="customer/form/resetforgottenpassword.phtml"/>
