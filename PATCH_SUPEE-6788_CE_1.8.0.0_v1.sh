...
SUPEE-6788 | CE_1.8.0.0 | v1 | 4fab03b385bef1d3a35663df2a8ea7c56e1cc1d6 | Fri Oct 23 13:45:41 2015 +0300 | 309c807
...
+            'changeforgotten',
             ...
             'resetpasswordpost',
             'confirm',
@@ -259,15 +263,21 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
      */
...
@@ -290,16 +300,15 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -368,7 +377,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
         $session->setCustomerFormData($this->getRequest()->getPost());
         if (is_array($errors)) {
...
@@ -376,6 +385,17 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
     }
...
@@ -734,23 +754,39 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
     /**
...
@@ -761,15 +797,14 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
      */
...
@@ -793,10 +828,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -806,14 +838,15 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -990,4 +1023,34 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
     {
